...
for i in {1..10}; do
    ./client/client localhost 8674 team1 2> logs/client_log_normal_probe_ten_clients_${i}.txt &
    sleep 0.5
done
./client/client localhost 8674 team1 2> logs/client_log_normal_probe_ten_clients_10.txt
