...
(cd server && ./zappy -p 8674 -x 10 -y 10 -n team1 -c 40 -f 10 > ../logs/server_log_normal_probe_ten_clients.txt 2>&1 &)
...
./client/client localhost 8674 team1 --no-fork 2> logs/client_log_normal_probe_ten_clients_40.txt
wait
